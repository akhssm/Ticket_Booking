...
const AddShows = () => {
  ...
  const [selectdMovies, setSelectedMovie] = useState(null);
  ...
  return nowPlayingMovies.length > 0 ?(
    <>
            ...
            {Object.entries(dateTimeSelection).map(([date, times]) => (
              <li key={date}>
                ...
                <div className="flex flex-wrap gap-2 mt-1 text-sm">
                  {times.map((time) => (
                    <div keys={time} className="border border-primary
      ...
      <button className="bg-primary text-white px-8 py-2 mt-2 rounded
